...
/**
 * 書籍架位資料表（`BookLocations`）遷移類別
 */
class BookLocations extends Migration
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'BookLocations';
    ...
    public function up()
    {
        $sqlArray = [
            ...
            */
            ...
            SQL,
            "COMMENT ON TABLE public.\"{$this->_tableName}\" IS '書籍架位資料表'",
            ...
            */
            ...
            "COMMENT ON COLUMN public.\"{$this->_tableName}\".\"Id\"        IS '書籍架位ID (流水號)'",
            "COMMENT ON COLUMN public.\"{$this->_tableName}\".\"Code\"      IS '書籍架位代碼'",
            "COMMENT ON COLUMN public.\"{$this->_tableName}\".\"Name\"      IS '書籍架位名稱'",
            ...
            */
            ...
            "COMMENT ON CONSTRAINT \"{$this->_tableName}_Id\" ON public.\"{$this->_tableName}\" IS '書籍架位資料表主鍵'",
            ...
            SQL,
            "COMMENT ON INDEX public.\"{$this->_tableName}_Code\" IS '書籍架位代碼索引（書籍架位資料表）'",
            ...
            SQL,
            "COMMENT ON INDEX public.\"{$this->_tableName}_Name\" IS '書籍架位名稱索引（書籍架位資料表）'",
            ...
            SQL,
            "COMMENT ON INDEX public.\"{$this->_tableName}_CreatedAt\" IS '資料創建時間（書籍架位資料表）'",
            ...
            SQL,
            "COMMENT ON INDEX public.\"{$this->_tableName}_UpdatedAt\" IS '資料最後更新時間（書籍架位資料表）'",
