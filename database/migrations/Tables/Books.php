        ...
        $sqlArray = [
            ...
            */
            ...
            (
                ...
                "OriginalName"     character varying(1000)  COLLATE pg_catalog."C.UTF-8"      NULL,
                "Author"           character varying(200)   COLLATE pg_catalog."C.UTF-8"      NULL,
                "Illustrator"      character varying(200)   COLLATE pg_catalog."C.UTF-8"      NULL,
                "Editor"           character varying(200)   COLLATE pg_catalog."C.UTF-8"      NULL,
                "Translator"       character varying(200)   COLLATE pg_catalog."C.UTF-8"      NULL,
                "Series"           character varying(200)   COLLATE pg_catalog."C.UTF-8"      NULL,
                "Publisher"        character varying(200)   COLLATE pg_catalog."C.UTF-8"      NULL,
                ...
                "Notes"            text                                                       NULL,
                "ISN"              character varying(13)    COLLATE pg_catalog."C.UTF-8"      NULL,
                "EAN"              character varying(13)    COLLATE pg_catalog."C.UTF-8"      NULL,
            ...
            */
            ...
            "COMMENT ON COLUMN public.\"{$this->_tableName}\".\"ISN\"             IS 'ISBN或ISSN (不含連字號)'",
            "COMMENT ON COLUMN public.\"{$this->_tableName}\".\"EAN\"             IS '國際商品條碼 (不含連字號)'",
